...
hasObstacle( mapX, mapY ) {
  ...
  getRelactiveFingerPosition( fingerPosition ) {
      ...
      if ( inRange( _relactiveFingerPosition.x, 0, this.size*this.data[0].length ) && inRange( _relactiveFingerPosition.y, 0, this.size*this.length ) ) return _relactiveFingerPosition;
      return false;
    }
